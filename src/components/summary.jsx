...
const Summary = () => {
  ...
  const handleSend = async () => {
    ...
    const systemMessage = {
      ...
      7. Include a short disclaimer in your responses when you are confused or unsure: "This information is based only on your consultation. If your symptoms change or you need further support, please follow up with your doctor."
